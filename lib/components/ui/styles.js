...
exports.StyledPageDescription = exports.StyledPageHeader = exports.StyledA = exports.StyledButtonLink = exports.StyledButton = exports.StyledErr = exports.StyledTextInput = exports.colors = void 0;
...
var StyledA = _styledComponents["default"].a(_templateObject6 || (_templateObject6 = (0, _taggedTemplateLiteral2["default"])(["\n    ", ";\n    text-decoration: none;\n    display: block;\n    \n    ", "\n"])), StyledButtonCss, function (state) {
  var _state$appearance13, _state$appearance14, _state$appearance15;

  return state.disabled ? "\n        color: ".concat(colors[((_state$appearance13 = state.appearance) !== null && _state$appearance13 !== void 0 ? _state$appearance13 : "normal") + "_disabled"].text, ";\n        background: ").concat(colors[((_state$appearance14 = state.appearance) !== null && _state$appearance14 !== void 0 ? _state$appearance14 : "normal") + "_disabled"].background, ";\n        border: 1px solid ").concat(colors[((_state$appearance15 = state.appearance) !== null && _state$appearance15 !== void 0 ? _state$appearance15 : "normal") + "_disabled"].border, ";\n    ") : null;
});

exports.StyledA = StyledA;
var StyledPageHeader = (0, _styledComponents["default"])(_reactGridSystem.Col)(_templateObject7 || (_templateObject7 = (0, _taggedTemplateLiteral2["default"])(["\n  font-size: 22px;\n  line-height: 33px;\n  font-weight: 500;\n  color: ", ";\n  margin-bottom: 20px;\n  padding: 0!important;\n"])), colors.normal.text);
exports.StyledPageHeader = StyledPageHeader;
var StyledPageDescription = (0, _styledComponents["default"])(_reactGridSystem.Col)(_templateObject8 || (_templateObject8 = (0, _taggedTemplateLiteral2["default"])(["\n  font-size: 16px;\n  line-height: 24px;\n  font-weight: 400;\n  color: ", ";\n  margin-bottom: 40px;\n  padding: 0!important;\n"])), colors.normal.text);
